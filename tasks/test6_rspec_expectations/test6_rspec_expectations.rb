# 1. Modify unit tests for your trello model (from classes task) using rspec matchers
#
# 2. Switch all your project assertions to rspec matchers
...
# user1 has created two boards: Work & Home
    ...
    expect(board_work.board_name).to eql "Work"
    user.create_board(board_home.board_name)
    expect(board_home.board_name).to eql "Home"
